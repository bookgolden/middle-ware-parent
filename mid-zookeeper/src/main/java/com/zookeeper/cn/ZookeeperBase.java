...
/**
 * https://www.php.cn/java-article-379582.html
...
public class ZookeeperBase {
    ...
    /** zookeeper地址 */
    static final String CONNECT_ADDR = "192.168.1.3:2181";
    /** session超时时间 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("..");
        // 创建父节点
//         zk.create("/testRoot", "testRootVVVVV".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,
